Updates `Forgotten Factions for DeCiv` from the repository pinned in `mods-manifest.json`.
...
- `python tools/mods/mod_repo_manager.py update-one --mod "forgotten-factions-for-deciv" --dry-run`
