Updates `Outlaws of the Wastes` from the repository pinned in `mods-manifest.json`.
...
- `python tools/mods/mod_repo_manager.py update-one --mod "outlaws-of-the-wastes" --dry-run`
