Updates `Steampunk Nations for DeCiv` from the repository pinned in `mods-manifest.json`.
...
- `python tools/mods/mod_repo_manager.py update-one --mod "steampunk-nations-for-deciv" --dry-run`
